...
<body>
    <div class="container">
        <div class="blog-container">
            ...
            <h1 class="text-center mt-4">Hello world DevOps Learning Journey</h1>
            ...
            <div class="content">
                ...
                <ul>
                    <li>Improved collaboration and communication between teams.</li>
                    <li>Faster delivery of features and updates.</li>
                    <li>Enhanced security and reliability through automated testing and monitoring.</li>
                    <li>Increased customer satisfaction through timely and consistent releases.</li>
                </ul>
